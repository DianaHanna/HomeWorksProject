...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println(" --- Creating an object of SuperSavings account");

        SuperSavings sSavings=new SuperSavings();
        sSavings.accountNumber=54646846556l;
        sSavings.money=54888;
        sSavings.profit=500;
        sSavings.savingAmount=6845641;
        // sSavings.interest -> error from Checking account

        sSavings.deposit();
        sSavings.takeProfit();
        sSavings.superSavings();
        // sSavings.transfer(); -> error because it's from Checking account
